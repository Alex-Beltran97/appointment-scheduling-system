...
const RegisterFormComponent = ({ userType }: IProps) => {
  const {
    citiesData,
    countriesData,
    departmentsData,
  ...
  const { handleSubmit, initialValues } = useLogin(userType);
        ...
        {({
          ...
          <Form className={styles.form__container}>
              ...
              <DatePicker
                ...
                slotProps={{
                  textField: {
                    ...
                    helperText:
                      touched.birthDate && typeof errors.birthDate === 'string'
                        ? errors.birthDate
                        : '',
                    onBlur: handleBlur,
                  },
            ...
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} label="Indicativo de pais" />
              )}
            />
            <TextField
              id="phone"
            ...
            <TextField
              ...
              helperText={
                touched.nitCode && errors.nitCode ? errors.nitCode : ''
              }
              disabled={userType === UserType?.company}
            />
            <TextField
              id="username"
              name="username"
