...
import { companyRouter, contractRouter, employeeRouter, docTypeRouter, employeeRoleRouter, userRoleRouter, profileRouter, paymentStatusRouter } from '../routers/auth';
